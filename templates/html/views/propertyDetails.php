    ...
    <?php if (!empty($property->deprecatedSince) || !empty($property->deprecatedReason)): ?>
        <div class="doc-description deprecated">
            <strong>Deprecated <?php
                ...
                if (!empty($property->deprecatedReason)) { echo ApiMarkdown::process($property->deprecatedReason, array($type, $property->inheritsFrom), true); }
                ?></strong>
        </div>
    <?php endif; ?>

    <div class="doc-description">
        <?= ApiMarkdown::process($property->description, array($type, $property->inheritsFrom)) ?>
